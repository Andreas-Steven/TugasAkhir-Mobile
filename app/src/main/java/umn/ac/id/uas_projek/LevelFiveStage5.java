...
public class LevelFiveStage5 extends AppCompatActivity {
    Button bt1, bt2, bt3, bt4, btplay, btback;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level_five_stage5);
        ...
        btback.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent back = new Intent(LevelFiveStage5.this, LevelFive.class);
                startActivity(back);
            }
        });
        ...
        bt1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                benar.show();
                Intent next = new Intent(LevelFiveStage5.this, LevelFive.class);
                startActivity(next);
            }
        });
