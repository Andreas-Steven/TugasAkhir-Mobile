...
public class LevelTwoStage3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.rokujoumaop);
        ...
        btback.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent back = new Intent(LevelTwoStage3.this, LevelTwo.class);
                startActivity(back);
            }
        });
        ...
        bt4.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                benar.show();
                Intent next = new Intent(LevelTwoStage3.this, LvlOneStageFive.class);
                startActivity(next);
            }
        });
    }
