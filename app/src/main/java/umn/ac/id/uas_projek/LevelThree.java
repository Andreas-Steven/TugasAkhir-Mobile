...
public class LevelThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        st1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent IntentLevel1 = new Intent(LevelThree.this, LevelThreeStage1.class);
        ...
        st2.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent IntentLevel2 = new Intent(LevelThree.this, LevelThreeStage2.class);
        ...
        st3.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent IntentLevel3 = new Intent(LevelThree.this, LevelThreeStage3.class);
        ...
        st4.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent IntentLevel4 = new Intent(LevelThree.this, LevelThreeStage4.class);
        ...
        st5.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                Intent IntentLevel5 = new Intent(LevelThree.this, LevelThreeStage5.class);
