...
public class LevelThreeStage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.ginnosajiop);
        ...
        btback.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent back = new Intent(LevelThreeStage2.this, LevelThree.class);
                startActivity(back);
            }
        });
        ...
        bt1.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                benar.show();
                Intent next = new Intent(LevelThreeStage2.this, LevelThreeStage3.class);
                startActivity(next);
            }
        });
