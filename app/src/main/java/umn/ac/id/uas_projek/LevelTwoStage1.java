    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btplay.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    // Trinity Seven
                    mp.setDataSource("https://firebasestorage.googleapis.com/v0/b/vvibuumn-guesttheanimu.appspot.com/o/trinityseven.mp3?alt=media&token=fb45df0e-2caf-4d79-918b-58c068257e2e"); // Link dari Firebase Storage
