...
public class LevelThreeStage1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_three_stage1);
        ...
        final MediaPlayer mp = MediaPlayer.create(this, R.raw.killlakill);
        ...
        btback.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent back = new Intent(LevelThreeStage1.this, LevelThree.class);
                startActivity(back);
            }
        });
        ...
        bt3.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                benar.show();
                Intent next = new Intent(LevelThreeStage1.this, LevelThreeStage2.class);
                startActivity(next);
            }
        });
